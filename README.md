<div align="center">
  ...
  <p>一款 Windows 螢幕翻譯工具，支援截圖、即時、取詞與快速翻譯，翻譯結果直接顯示在原畫面上。</p>
...
OverTranslate 提供五種翻譯方式，可依不同使用情境快速選擇：

- **截圖翻譯** — 框選畫面內容，辨識並將譯文直接顯示在原畫面
- **即時翻譯** — 即時翻譯影片 / 遊戲畫面指定區域，並將譯文顯示在原畫面上
- **取詞翻譯** — 選取文字後開啟精簡翻譯小視窗，也可釘選常駐使用
- **快速翻譯** — 選取文字後按下快捷鍵，直接翻譯並取代原文
- **文字翻譯** — 使用完整翻譯視窗，支援文字輸入、語言互換與文字朗讀
...
| 快速翻譯 (快捷鍵) | 直接將選取的文字取代為翻譯結果 (預設 `Ctrl + Alt + E`)；未選取文字時不會有任何動作 |
